...
public final class LovelaceLogger {
	...
	public static void setWriter(final PrintStream newWriter) {
		writer = newWriter;
	}
	...
	private static void log(final Level messageLevel, final String format, final Object... args) {
	...
	@SuppressWarnings("TypeMayBeWeakened")
	private static void log(final Throwable exception, final Level messageLevel,
	...
	public static void warning(final Throwable exception, final String format, final Object... args) {
