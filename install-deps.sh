...
wget https://github.com/tofi86/universalJavaApplicationStub/archive/v3.0.2.tar.gz -O \
		universalJavaApplicationStub-3.0.2.tar.gz
tar xzf universalJavaApplicationStub-3.0.2.tar.gz
