...
wget https://github.com/tofi86/universalJavaApplicationStub/archive/v2.1.0.tar.gz -O \
		universalJavaApplicationStub-2.1.0.tar.gz
tar xzf universalJavaApplicationStub-2.1.0.tar.gz
