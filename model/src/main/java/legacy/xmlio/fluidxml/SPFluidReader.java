...
public class SPFluidReader implements IMapReader, ISPReader {
	...
	private record SimpleFixtureReader(String tag, IntFunction<Object> factory) {
		...
		public Pair<String, FluidXMLReader<?>> getPair() {
			return Pair.with(tag, (element, parent, stream, players, warner, idFactory) -> reader(element, parent,
	...
	public SPFluidReader() {
		...
		temp.put("adventure", (element1, parent1, stream1, players1, warner1, idFactory1) ->
				FluidExplorableHandler.readAdventure(element1, parent1, stream1, players1, warner1, idFactory1));
		temp.put("portal", (element1, parent1, stream1, players1, warner1, idFactory1) ->
				FluidExplorableHandler.readPortal(element1, parent1, stream1, players1, warner1, idFactory1));
		temp.put("cave", (element, parent, stream, players, warner, idFactory) ->
				FluidExplorableHandler.readCave(element, parent, stream, players, warner, idFactory));
		temp.put("battlefield", (element3, parent3, stream3, players3, warner3, idFactory3) ->
				FluidExplorableHandler.readBattlefield(element3, parent3, stream3, players3, warner3, idFactory3));
		temp.put("ground", (element5, parent5, stream5, players5, warner5, idFactory5) ->
				FluidTerrainHandler.readGround(element5, parent5, stream5, players5, warner5, idFactory5));
		temp.put("forest", (element5, parent5, stream5, players5, warner5, idFactory5) ->
				FluidTerrainHandler.readForest(element5, parent5, stream5, players5, warner5, idFactory5));
		temp.put("animal", (element7, parent7, stream7, players7, warner7, idFactory7) ->
				UnitMemberHandler.readAnimal(element7, parent7, stream7, players7, warner7, idFactory7));
		temp.put("text", (element6, parent6, stream6, players6, warner6, idFactory6) ->
				FluidExplorableHandler.readTextFixture(element6, parent6, stream6, players6, warner6, idFactory6));
		temp.put("implement", (element6, parent6, stream6, players6, warner6, idFactory6) ->
				FluidResourceHandler.readImplement(element6, parent6, stream6, players6, warner6, idFactory6));
		temp.put("resource", (element4, parent4, stream4, players4, warner4, idFactory4) ->
				FluidResourceHandler.readResource(element4, parent4, stream4, players4, warner4, idFactory4));
		temp.put("cache", (element2, parent2, stream2, players2, warner2, idFactory2) ->
				FluidResourceHandler.readCache(element2, parent2, stream2, players2, warner2, idFactory2));
		temp.put("grove", (element5, parent5, stream5, players5, warner5, idFactory5) ->
				FluidResourceHandler.readGrove(element5, parent5, stream5, players5, warner5, idFactory5));
		temp.put("orchard", (element5, parent5, stream5, players5, warner5, idFactory5) ->
				FluidResourceHandler.readOrchard(element5, parent5, stream5, players5, warner5, idFactory5));
		temp.put("meadow", (element4, parent4, stream4, players4, warner4, idFactory4) ->
				FluidResourceHandler.readMeadow(element4, parent4, stream4, players4, warner4, idFactory4));
		temp.put("field", (element6, parent6, stream6, players6, warner6, idFactory6) ->
				FluidResourceHandler.readField(element6, parent6, stream6, players6, warner6, idFactory6));
		temp.put("mine", (element3, parent3, stream3, players3, warner3, idFactory3) ->
				FluidResourceHandler.readMine(element3, parent3, stream3, players3, warner3, idFactory3));
		temp.put("mineral", (element6, parent6, stream6, players6, warner6, idFactory6) ->
				FluidResourceHandler.readMineral(element6, parent6, stream6, players6, warner6, idFactory6));
		temp.put("shrub", (element4, parent4, stream4, players4, warner4, idFactory4) ->
				FluidResourceHandler.readShrub(element4, parent4, stream4, players4, warner4, idFactory4));
		temp.put("stone", (element4, parent4, stream4, players4, warner4, idFactory4) ->
				FluidResourceHandler.readStone(element4, parent4, stream4, players4, warner4, idFactory4));
		temp.put("worker", (element7, parent7, stream7, players7, warner7, idFactory7) ->
				UnitMemberHandler.readWorker(element7, parent7, stream7, players7, warner7, idFactory7));
		temp.put("job", (element1, parent1, stream1, players1, warner1, idFactory1) ->
				UnitMemberHandler.readJob(element1, parent1, stream1, players1, warner1, idFactory1));
		temp.put("skill", (element5, parent5, stream5, players5, warner5, idFactory5) ->
				UnitMemberHandler.readSkill(element5, parent5, stream5, players5, warner5, idFactory5));
		temp.put("stats", (element3, parent3, stream3, players3, warner3, idFactory3) ->
				UnitMemberHandler.readStats(element3, parent3, stream3, players3, warner3, idFactory3));
		temp.put("unit", (element2, parent2, stream2, players2, warner2, idFactory2) ->
				readUnit(element2, parent2, stream2, players2, warner2, idFactory2));
		temp.put("fortress", (element1, parent1, stream1, players1, warner1, idFactory1) ->
				readFortress(element1, parent1, stream1, players1, warner1, idFactory1));
		temp.put("town", (element6, parent6, stream6, players6, warner6, idFactory6) ->
				FluidTownHandler.readTown(element6, parent6, stream6, players6, warner6, idFactory6));
		temp.put("city", (element2, parent2, stream2, players2, warner2, idFactory2) ->
				FluidTownHandler.readCity(element2, parent2, stream2, players2, warner2, idFactory2));
		temp.put("fortification", (element5, parent5, stream5, players5, warner5, idFactory5) ->
				FluidTownHandler.readFortification(element5, parent5, stream5, players5, warner5, idFactory5));
		temp.put("village", (element4, parent4, stream4, players4, warner4, idFactory4) ->
				FluidTownHandler.readVillage(element4, parent4, stream4, players4, warner4, idFactory4));
		temp.put("map", (element, parent, stream, players, warner, idFactory) ->
				readMapOrViewTag(element, parent, stream, players, warner, idFactory));
		temp.put("view", (element3, parent3, stream3, players3, warner3, idFactory3) ->
				readMapOrViewTag(element3, parent3, stream3, players3, warner3, idFactory3));
		temp.put("river", (element2, parent2, stream2, players2, warner2, idFactory2) ->
				FluidTerrainHandler.readRiver(element2, parent2, stream2, players2, warner2, idFactory2));
		temp.put("lake", (element1, parent1, stream1, players1, warner1, idFactory1) ->
				FluidTerrainHandler.readLake(element1, parent1, stream1, players1, warner1, idFactory1));
		temp.put("player", (element1, parent1, stream1, players1, warner1, idFactory1) ->
				readPlayer(element1, parent1, stream1, players1, warner1, idFactory1));
		temp.put("population", (element, parent, stream, players, warner, idFactory) ->
				FluidTownHandler.readCommunityStats(element, parent, stream, players, warner, idFactory));
