...
public final class DBTownHandler extends AbstractDatabaseWriter<AbstractTown, Point> implements MapContentsReader {
	...
	private static final Query INSERT_SQL =
			Query.of("""
					...
					VALUES(:row, :column, :id, :kind, :status, :size, :dc, :name, :owner, :image,
						:portrait, :population);""");
