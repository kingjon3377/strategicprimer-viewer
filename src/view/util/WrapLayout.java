 ...
 * http://tips4java.wordpress.com/2008/11/06/wrap-layout/ ; the "about
 * us" page says code from that blog may be used "without restriction."
 *
 * @author Rob Camick
 */
	...
	public Dimension preferredLayoutSize(@Nullable final Container target) {
		if (target == null) {
			throw new IllegalArgumentException(
					"Asked to lay out a null container");
		} else {
