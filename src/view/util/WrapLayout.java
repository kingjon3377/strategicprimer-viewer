 ...
 * http://tips4java.wordpress.com/2008/11/06/wrap-layout/ ; the "about us" page says code
 * from that blog may be used "without restriction."
 *
 * @author Rob Camick
 */
public final class WrapLayout extends FlowLayout {
	 ...
	 * default
	 * 5-unit horizontal and vertical gap. The value of the alignment argument must be
	 * one
	 * of <code>WrapLayout</code>, <code>WrapLayout</code>, or <code>WrapLayout</code>.
	 *
	 ...
	 * horizontal and vertical gaps. <p> The value of the alignment argument must be one
	 * of <code>WrapLayout</code>, <code>WrapLayout</code>, or <code>WrapLayout</code>.
	 *
	 * @param align the alignment value
	 ...
	 * @return its preferred dimensions
	 */
	@Override
	public Dimension preferredLayoutSize(@Nullable final Container target) {
		if (target == null) {
			throw new IllegalArgumentException(
					                                  "Asked to lay out a null " +
							                                  "container");
		} else {
	 ...
	 */
	@Override
	public Dimension minimumLayoutSize(@Nullable final Container target) {
		if (target == null) {
			throw new IllegalArgumentException(
					                                  "Asked to lay out a null " +
							                                  "container");
		...
		synchronized (target.getTreeLock()) {
			...
			for (int i = 0; i < nmembers; i++) {
				...
				if (member.isVisible()) {
					...
					if (preferred) {
						dimension = member.getPreferredSize();
					} else {
						dimension = member.getMinimumSize();
					}
