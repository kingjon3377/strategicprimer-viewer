...
public interface IMapReader {
	 ...
	 */
	SPMap readMap(final String file) throws IOException, XMLStreamException, SPFormatException, MapVersionException;
	 ...
	 * @throws MapVersionException if the reader can't handle this map version
	 */
	SPMap readMap(final InputStream istream) throws XMLStreamException, SPFormatException, MapVersionException;
}
