...
public class SphinxNode extends AbstractFixtureNode<Sphinx> {
	 ...
	 */
	@Override
	public Sphinx produce(final PlayerCollection players, final Warning warner)
			throws SPFormatException {
		return new Sphinx(Integer.parseInt(getProperty("id")),
				getProperty("file"));
	}
	...
	public void checkNode(final Warning warner, final IDFactory idFactory)
			throws SPFormatException {
		forbidChildren("sphinx");
		registerOrCreateID("sphinx", idFactory, warner);
	}
