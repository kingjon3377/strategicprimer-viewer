...
public class GroundNode extends AbstractFixtureNode<Ground> {
	 ...
	 * @throws SPFormatException if the element was missing any required
	 *         properties
	 */
	@Override
	public Ground produce(final PlayerCollection players, final Warning warner)
	...
	public boolean canUse(final String property) {
		return EqualsAny.equalsAny(property, KIND_PROPERTY, EXPOSED_PARAM,
				OLD_KIND_PARAM);
	}

	/**
	 * Check whether the node is valid. A Ground is valid if it has "ground" and
	 * "exposed" properties and no children. TODO: add further properties.
	 * 
	 * @param warner a Warning instance to use for warnings
	...
	public void checkNode(final Warning warner, final IDFactory idFactory)
			throws SPFormatException {
		forbidChildren(TAG);
		handleDeprecatedProperty(TAG, KIND_PROPERTY, OLD_KIND_PARAM, warner,
				true, false);
