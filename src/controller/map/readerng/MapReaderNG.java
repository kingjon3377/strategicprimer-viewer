 ...
 * SimpleXMLReader but allowing for more complex types that don't map 1:1 to the XML.
 *
...
public final class MapReaderNG implements IMapReader, ISPReader {
	 ...
	 * @throws SPFormatException  if the format isn't one we support or if the data is
	 *                            invalid
	 */
	@Override
	 ...
	 * @throws XMLStreamException if the XML isn't well-formed
	 * @throws SPFormatException  if the data is invalid, including if the map version
	...
	/**
	 * Helper method: check that an XMLWritable is in fact assignable to the specified
	 * type. Return it if so; if not throw IllegalArgumentException.
	 *
