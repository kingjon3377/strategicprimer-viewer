...
public final class AnimalReportGenerator extends AbstractReportGenerator<Animal> {
	 ...
	 */
	public AnimalReportGenerator(final PairComparator<@NonNull Point, @NonNull IFixture>
										 comparator) {
		super(comparator);
	}
	/**
	...
	public IReportNode produceRIR(final PatientMap<Integer, Pair<Point, IFixture>>
		...
		return new SimpleReportNode(loc, "At %s: %s%s %s", loc.toString(),
										   tracesOrTalking, item.getKind(),
