...
shared object oneToTwoConverter {
	...
	shared IMapNG convertOneToTwo(
			...
			ExplorationRunner runner, // TODO: Maybe make oneToTwoConverter a class with this as its parameter?
		...
		suppressWarnings("deprecation")
		void convertSubTile(Point point) { // TODO: take parameters and move to top level
...
//                retval.mountainous[point], retval.fixtures[point], retval.dimensions), // TODO: syntax sugar once compiler bug fixed
		...
		{Point*} convertTile(Point point) { // TODO: take parameters and move to top level
