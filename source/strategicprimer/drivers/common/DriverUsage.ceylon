shared class DriverUsage satisfies IDriverUsage {
    ...
    shared new (
            ...
            "Whether to include in a GUI list for the user to choose from."
            Boolean includeInGUIList,
            "A description of the first (non-option) parameter, for use in a usage
             statement."
            String firstParamDescription = "filename.xml",
            "A description of a later parameter, for use in a usage statement. (We assume
             that all parameters after the first should be described similarly.)"
