...
shared interface ProxyFor<Type> /* satisfies T */ given Type satisfies Object {
    ...
    "If there is consensus among proxied items on the given property, return it; otherwise return null."
    shared default MemberType? getConsensus<MemberType>(MemberType(Type) accessor) given MemberType satisfies Object {
