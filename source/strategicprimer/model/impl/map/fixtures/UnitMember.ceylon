...
"A (marker) interface for things that can be part of a unit.
 ...
 We extend [[strategicprimer.model.impl.map::Subsettable]] to make Unit's subset calculation
 show differences in workers, but without hard-coding
 [[strategicprimer.model.impl.map.fixtures.mobile::Worker]] in the Unit implementation. Most
