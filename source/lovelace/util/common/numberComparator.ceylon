...
"An object providing a comparison for [[Numbers|Number]] of unknown or varied types. In
 ...
 supported. Passing any unsupported type will raise an [[AssertionError]]."
...
"In addition to cross-platform types, [[Decimals|Decimal]] are supported on the JVM."
native("jvm")
...
shared object numberComparator satisfies Comparator<Number<out Anything>> {
    "Convert an arbitrary Number to a Float."
    native("js") shared Float floatValue(Number<out Anything> number) {
